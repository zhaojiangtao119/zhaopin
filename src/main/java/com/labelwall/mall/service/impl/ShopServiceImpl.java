...
public class ShopServiceImpl implements IShopService {
	...
	@Override
	public ResponseObject<String> deletePro(ShopDto shopDetailByUserId, Integer productId) {
		...
		if(productDto.getShopId()!=shopDetailByUserId.getId()){
			return ResponseObject.fail(ShopEnum.DATA_PROBLEM.getState(), ShopEnum.DATA_PROBLEM.getStateInfo());
		}
	...
	@Override
	public ResponseObject<String> deleteService(ShopDto shopDetailByUserId, Integer serviceId) {
		ShopServices shopServiceBySelect = shopServiceMapper.getServiceDetailById(serviceId);
		if(shopServiceBySelect==null){
			return ResponseObject.fail(ShopEnum.DATA_PROBLEM.getState(), ShopEnum.DATA_PROBLEM.getStateInfo());
		}
		if(shopServiceBySelect.getShopId()!=shopDetailByUserId.getId()){
			return ResponseObject.fail(ShopEnum.DATA_PROBLEM.getState(), ShopEnum.DATA_PROBLEM.getStateInfo());
		}
		int result = shopServiceMapper.deleteServiceById(serviceId);
		if(result>0){
			return ResponseObject.successStatus();
		}else{
			return ResponseObject.fail(ShopEnum.ERRO.getState(), ShopEnum.ERRO.getStateInfo());
	...
	public List<TradeType> getAllTradeType() {
		return shopMapper.getAllTradeType();
	}
}
